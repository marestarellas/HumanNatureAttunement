...
\begin{lstlisting}
# 1. Install the package with the video extras. opencv-python is
#    required to decode video; pydmd is optional (the modal extractor
#    falls back to a POD/SVD baseline if missing). scipy / antropy /
#    neurokit2 are base deps of the toolbox and already get installed
...
tectonic reports/video_v3/video_v3.tex
\end{lstlisting}
