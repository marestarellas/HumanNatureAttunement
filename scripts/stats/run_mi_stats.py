...
def main():
    ...
    parser.add_argument('--results-dir', type=str, default=None,
                       help='Results directory (default: <repo>/results/audio_eeg_mutual_information)')
    parser.add_argument('--figures-dir', type=Path, default=None,
                       help='Figures directory (default: <repo>/figures/audio_eeg_mutual_information)')

    args = parser.parse_args()

    # Setup paths (repo-root resolved)
    ...
    if args.figures_dir is None:
        figures_dir = project_dir / 'figures' / 'audio_eeg_mutual_information'
    else:
