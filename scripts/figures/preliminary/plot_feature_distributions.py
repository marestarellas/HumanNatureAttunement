...
def main():
    ...
    print("  [OK] Using all subject×channel observations (more power)")
    print("  [OK] Accounting for both subject and channel variability")
    print("  [OK] Proper repeated measures structure")
