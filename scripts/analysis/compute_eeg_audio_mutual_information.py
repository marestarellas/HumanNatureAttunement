...
Usage:
    python compute_eeg_audio_mutual_information.py --subjects 2 3 5 --conditions VIZ AUD MULTI
    python compute_eeg_audio_mutual_information.py --subjects 2 --conditions VIZ --n-bins 20
"""
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default=None,
                       help='Output directory (default: <repo>/results/audio_eeg_mutual_information)')
